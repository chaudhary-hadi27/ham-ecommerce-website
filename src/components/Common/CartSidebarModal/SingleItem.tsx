    ...
    <div className="flex items-center justify-between gap-5">
      <div className="w-full flex items-center gap-6">
        <div className="flex items-center justify-center rounded-[10px] bg-gray-3 max-w-[90px] w-full h-22.5 overflow-hidden">
          <Image src={getProductThumbnailUrl(item.imgs?.thumbnails?.[0] || '/images/products/product-placeholder.png')} alt={item.title} width={90} height={90} className="object-contain" />
        </div>
        ...
        <div>
          ...
          <p className="text-custom-sm">Price: Rs. {item.discountedPrice.toLocaleString()}</p>
        </div>
      </div>
